...
{
    /// <inheritdoc />
    public partial class Migratie_care_merge_uneori : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookmark_Has_Categories", x => new { x.Id, x.BookmarkId, x.CategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookmark_Has_Images", x => new { x.Id, x.BookmarkId, x.ImageId });
                    table.ForeignKey(
